				...
				if(komut_index > 0) {
					...
					if(strcmp(cmd, "help") == 0) {
						print("Komutlar:\n"
							  ...
							  "Asagi veya yukari ok tuslariyla asagi veya yukari kaydirma yapabilirsiniz.\n", default_color);
					}
						...
						print("Z.eSystem Plus 3SU\n", default_color);
						print("ESUI 1.2.2\n", default_color);
						print("ZeSys Kernel 1.3.0.1\n", default_color);
					}
						...
						else if(strcmp(arg, "4") == 0) default_color = 0x09;
						clear();
					}
